...
# Monkey patch VMContext._cleanup_after_deactivate to preserve SDK in sys.path and sys.modules
_orig_cleanup = VMContext._cleanup_after_deactivate
def _new_cleanup(self):
    import os as _os
...
VMContext._cleanup_after_deactivate = _new_cleanup
